...
public class WanderingTraderYakSpawnEggItem extends SpawnEggItem {
    public WanderingTraderYakSpawnEggItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (result.consumesAction() && !context.getLevel().isClientSide() && context.getPlayer() != null) {
            ...
            context.getLevel().getEntitiesOfClass(WanderingTraderYakEntity.class, new AABB(spawnPos).inflate(1.0)).stream()
