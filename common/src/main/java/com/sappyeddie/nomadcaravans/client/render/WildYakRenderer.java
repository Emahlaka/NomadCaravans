...
public class WildYakRenderer<R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<WildYakEntity, R> {
    ...
    private static final DataTicket<Float> ROPE_SWING_X =
            DataTicket.create("nomadcaravans_wild_yak_rope_swing_x", Float.class);
    private static final DataTicket<Float> ROPE_SWING_Z =
            DataTicket.create("nomadcaravans_wild_yak_rope_swing_z", Float.class);
    public WildYakRenderer(EntityRendererProvider.Context context) {
        super(context, new WildYakModel());
        this.withRenderLayer(new AutoGlowingGeoLayer<>(this));
    }

    @Override
    public void addRenderData(WildYakEntity animatable, Void relatedObject, R renderState, float partialTick) {
    ...
    public void adjustModelBonesForRender(RenderPassInfo<R> renderPassInfo, BoneSnapshots snapshots) {
        ...
        snapshots.ifPresent("saddle2", boneSnapshot -> boneSnapshot.skipRender(!hasSaddle));
        snapshots.ifPresent("saddle3", boneSnapshot -> boneSnapshot.skipRender(!hasSaddle));
        snapshots.ifPresent("saddle4", boneSnapshot -> boneSnapshot.skipRender(!hasSaddle));
        ...
        snapshots.ifPresent("rope_physics", boneSnapshot -> {
            ...
            boneSnapshot.skipRender(!hasSaddle);
        });
