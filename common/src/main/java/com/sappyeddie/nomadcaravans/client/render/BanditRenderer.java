...
public class BanditRenderer
        extends HumanoidMobRenderer<BanditEntity, HumanoidRenderState, NomadGuardModel> {

    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath("nomadcaravans", "textures/entity/bandit.png");

    private static final Identifier HEAD_TEXTURE =
            Identifier.fromNamespaceAndPath("nomadcaravans", "textures/entity/bandit_head.png");
    ...
    @Override
    public void extractRenderState(BanditEntity entity, HumanoidRenderState renderState, float partialTick) {
