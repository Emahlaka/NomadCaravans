...
public class UntameableWanderingTraderYakEntity extends Animal implements GeoEntity {

    private static final EntityDataAccessor<Boolean> DATA_HAS_WOOL =
            SynchedEntityData.defineId(UntameableWanderingTraderYakEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public UntameableWanderingTraderYakEntity(EntityType<? extends UntameableWanderingTraderYakEntity> entityType, Level level) {
    ...
    public class WanderingTraderYakGrazeGoal extends Goal {
        ...
        private final UntameableWanderingTraderYakEntity yak;
        private int eatTime;

        public WanderingTraderYakGrazeGoal(UntameableWanderingTraderYakEntity yak) {
            this.yak = yak;
        }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        ...
        controllers.add(new AnimationController<UntameableWanderingTraderYakEntity>("reaction", 0, state -> {
