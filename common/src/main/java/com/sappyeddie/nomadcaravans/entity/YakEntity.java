...
public class YakEntity extends Animal implements GeoEntity {

    private static final EntityDataAccessor<Boolean> DATA_HAS_CHEST =
            SynchedEntityData.defineId(YakEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    private static final EntityDataAccessor<Byte> DATA_CARPET_COLOR =
            SynchedEntityData.defineId(YakEntity.class, EntityDataSerializers.BYTE);
    ...
    private static final EntityDataAccessor<String> DATA_OWNER_UUID =
            SynchedEntityData.defineId(YakEntity.class, EntityDataSerializers.STRING);
    ...
    private static ItemStack createDeed(YakEntity yak) {
    ...
    public YakEntity(EntityType<? extends YakEntity> entityType, Level level) {
    ...
    public class YakGrazeGoal extends Goal {
        ...
        private final YakEntity yak;
        private int eatTime;

        public YakGrazeGoal(YakEntity yak) {
            this.yak = yak;
        }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        ...
        controllers.add(new AnimationController<YakEntity>("reaction", 0, state -> {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
        ...
        if (baby != null) {
            ...
            if (partner instanceof YakEntity yakPartner) {
